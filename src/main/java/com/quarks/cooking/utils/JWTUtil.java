package com.quarks.cooking.utils;
...
public class JWTUtil {
    ...
    private final static String ISSUER = "COOKING";
    private final static String SUBJECT = "MASTER-X-TOKEN";
     ...
     * @return 是否正确
     */
    public static String buildToken(Integer uid, String password){
